package com.dicksoy.redis.idGeneratorTest;
...
import com.dicksoy.redis.lock.Lock;
import com.dicksoy.redis.lock.RedisBasedDistributedLock;
...
public class IDGeneratorTest {
    ...
    public void testV1_0() throws Exception {  
		SocketAddress addr = new InetSocketAddress("192.168.11.131", 6379);

		Jedis jedis1 = new Jedis("192.168.11.131", 6379);
		...
		Jedis jedis2 = new Jedis("192.168.11.131", 6379);  
